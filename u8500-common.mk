...
# Configs
PRODUCT_COPY_FILES += \
    device/samsung/u8500-common/config/egl.cfg:system/lib/egl/egl.cfg \
    device/samsung/u8500-common/config/wpa_supplicant.conf:system/etc/wifi/wpa_supplicant.conf
...
# Custom init / uevent
PRODUCT_COPY_FILES += \
    device/samsung/u8500-common/config/init.st-ericsson.rc:root/init.st-ericsson.rc \
    device/samsung/u8500-common/config/ueventd.st-ericsson.rc:root/ueventd.st-ericsson.rc

# Recovery bootstrap script
PRODUCT_COPY_FILES += \
    device/samsung/u8500-common/recovery/bootrec:root/sbin/bootrec \
    device/samsung/u8500-common/recovery/postrecoveryboot.sh:root/sbin/postrecoveryboot.sh


# HW Configs
PRODUCT_COPY_FILES += \
    device/samsung/u8500-common/config/omxloaders:system/omxloaders \
    device/samsung/u8500-common/config/ril_config:system/etc/ril_config \
    device/samsung/u8500-common/config/ste_modem.sh:system/etc/ste_modem.sh
